...
async function seedArjun() {
  ...
  const brandIdentity = await prisma.workspace.create({
    data: {
      ...
      progress: 45,
      publicToken: "sec_tok_brand_identity_99",
      sharedAt: new Date("2026-07-20T10:35:00Z"),
  ...
  const ecommerce = await prisma.workspace.create({
    data: {
      ...
      progress: 75,
      publicToken: "sec_tok_ecommerce_88",
      sharedAt: new Date("2026-07-15T09:05:00Z"),
  ...
  const productPkg = await prisma.workspace.create({
    data: {
      ...
      progress: 100,
      publicToken: "sec_tok_packaging_77",
      sharedAt: new Date("2026-07-02T14:05:00Z"),
  ...
  const socialCampaign = await prisma.workspace.create({
    data: {
      ...
      progress: 10,
      publicToken: "sec_tok_social_campaign_66",
...
async function seedMeera() {
  ...
  const portfolio = await prisma.workspace.create({
    data: {
      ...
      status: WorkspaceStatus.IN_REVIEW,
      progress: 45,
      publicToken: "sec_tok_portfolio_refresh_11",
      sharedAt: new Date("2026-07-21T09:00:00Z"),
  ...
  const menuDesign = await prisma.workspace.create({
    data: {
      ...
      status: WorkspaceStatus.PAID,
      progress: 100,
      publicToken: "sec_tok_menu_design_22",
      sharedAt: new Date("2026-07-10T10:00:00Z"),
